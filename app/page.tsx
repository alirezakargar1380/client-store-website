...
//   let landingSection: any = []
//   let data: any = []

//   const fetchData = async () => {
//     // fetch('http://localhost:3002/api/landing-section-name').then(async (res: any) => {
//     //   const newData = await res.json();
//     //   return setLandingSection(newData);
//     // })
//     // // fetch('http://localhost:3002/api/products').then(async (res: any) => {
//     //   const newData = await res.json();
//     //   console.log(newData)
